...
\onehalfspace
	...
	\subsection{Strengths and Limitations}
		...
		This imporved the accuracy of measurement of secondary outcome, clinical athersclerotic cardiovascular disease events.
		...
		The effectiveness of this random allocation procedure can be seen in the comparabillity of groups in \hyperref{table1}, and shows the study has good internal validity.
		Primary outcome results were imporved by the use of trained ultrasonographers who had been assessed pre trial (see above)
		...
		The use of a convenience sample from Kaiser Permanente external validity may be limited, however it is likely that Kaiser Permanente clientele represetns a good sample of middle and upper class women hence findings are valid across this population.
